...
public class MyCSVReader {
    ...
    static String path = "C:\\Users\\lucas\\Desktop\\java_projeto\\BD\\IMDB Top 250 Movies.csv";
    
    public static void openArq() throws NumberFormatException, IOException{
        ...
        while(line != null){
            ...
            List<String> Genre = Arrays.asList(campos(brLine).split(","));
            ...
            String tagLine = campos(brLine);
            //System.out.println(i + " " + tagLine);
            int budget = Integer.parseInt(campos(brLine));
            //System.out.println(i + " " + budget);
            int boxOffice = Integer.parseInt(campos(brLine));
            ...
            try{
                ...
                Filme filme = new Filme( rank, name,  year,  rating,  Genre,  certificate,  runTime,  tagLine,  budget,  boxOffice,  casts, directors,  writers);
